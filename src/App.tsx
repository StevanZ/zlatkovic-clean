    ...
    <main>
      ...
      <section id="top" className="hero" aria-label="Dubinsko čišćenje">
        ...
        <div className="hero-content">
          <p className="eyebrow">
            Uskoro krećemo • Promo termini za prve klijente
          </p>
          <h1>Profesionalno dubinsko pranje za čistiji i zdraviji dom</h1>
          <p className="hero-text">
            Dubinsko pranje ugaonih garnitura, troseda, dušeka, stolica, tepiha
            i auto enterijera uz profesionalnu opremu i dolazak na adresu.
          </p>
      ...
      <section id="cenovnik" className="section split">
        <div className="section-heading compact">
          ...
          <span>
            Cene su informativne i mogu zavisiti od stanja nameštaja, veličine i
            lokacije.
          </span>
        </div>
      ...
      <section id="kontakt" className="contact-section">
        <div>
          ...
          <span>
            Napišite šta treba da se čisti, gde se nalazite i pošaljite sliku
            ako imate fleke koje želite posebno da proverimo.
          </span>
        </div>
